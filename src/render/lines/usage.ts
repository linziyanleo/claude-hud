...
export function renderUsageLine(
  ...
  if (usageCompact) {
    const fiveHourPart = fiveHour !== null
      ? formatCompactWindowPart("5h", fiveHour, forceCompact ? null : ctx.usageData.fiveHourResetAt, timeFormat, colors, usageValueMode)
      : null;
    const sevenDayPart = (sevenDay !== null && (fiveHour === null || sevenDay >= sevenDayThreshold))
      ? formatCompactWindowPart("7d", sevenDay, forceCompact ? null : ctx.usageData.sevenDayResetAt, timeFormat, colors, usageValueMode)
      : null;
